...
from transformers import (
    AdamW, OpenAIGPTDoubleHeadsModel, OpenAIGPTTokenizer,
    GPT2DoubleHeadsModel, GPT2Tokenizer, WEIGHTS_NAME, CONFIG_NAME
)

from gpt2_chatbot.bot_utils import get_dataset, make_logdir
import logging
...
def get_data_loaders(args, tokenizer):
    ...
    logger.info(
        f"Valid dataset (Batch, Candidates, Seq length): {valid_dataset.tensors[0].shape}")
...
def train():
    ...
    # we evaluate when we start the training and at the end of each epoch
